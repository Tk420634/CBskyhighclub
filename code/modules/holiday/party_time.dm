...
/datum/holiday/weekly/potluck/celebrate()
	. = ..()
	world.TgsTargetedChatBroadcast("<@&1147595783147880568> Come on down for the Foxybar meet, greet, n' eat!  Gather in new folks, won't be so lonely if you're all new together!  Let's get y'all settled in!", FALSE)
