...
GLOBAL_LIST_INIT(flirts, list("Roses are red / Violets are good / One day while Andy...",
		...
		"I must be a nuke op, because you make my heart explode.",
		...
		"If I was an alien, would you let me hug you?",
		...
		"Roses are red, tide is gray, if I was an assistant I'd steal you away.",
		...
		"I must be liquid dark matter, because you're pulling me closer.",
